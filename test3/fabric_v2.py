...
from cmsnet.cms_comp import *
from mininet.node import Node, RemoteController
from mininet.log import setLogLevel,info, error, debug, output

def makeNet ():
    net = CMSnet()   
    ctrl = net.mn.addController('c1', RemoteController)
    # add 2 HV
    HVswitches = []
    for i in range(0, 2):
      i += 1
    ...
    net.launchVM ( hosts[1].name, HVswitches[1].name)
    print hosts[0].cmd("ping 10.0.0.2 -c 3")
    print net.mn.nameToNode
